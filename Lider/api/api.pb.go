...
func (x *JugadasArchivo) Reset() {
	*x = JugadasArchivo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_Lider_api_api_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*JugadasArchivo) Descriptor() ([]byte, []int) {
	return file_Lider_api_api_proto_rawDescGZIP(), []int{12}
}
...
var file_Lider_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_Lider_api_api_proto_goTypes = []interface{}{
	...
	(*JugadaJugador)(nil),             // 10: api.JugadaJugador
	(*JugadorYEtapa)(nil),             // 11: api.JugadorYEtapa
	(*JugadasArchivo)(nil),            // 12: api.JugadasArchivo
}
var file_Lider_api_api_proto_depIdxs = []int32{
	...
	8,  // 4: api.Lider.CuantosJugadores:input_type -> api.Signal
	10, // 5: api.Lider.EscribirJugada:input_type -> api.JugadaJugador
	11, // 6: api.Lider.RetornarJugadas:input_type -> api.JugadorYEtapa
	1,  // 7: api.Lider.ParticiparJuego:output_type -> api.ConfirmacionParticipacion
	3,  // 8: api.Lider.Jugar:output_type -> api.EstadoJugador
	5,  // 9: api.Lider.Monto:output_type -> api.MontoJugador
	7,  // 10: api.Lider.EstadoEtapas:output_type -> api.State
	9,  // 11: api.Lider.CuantosJugadores:output_type -> api.CantidadJugadores
	8,  // 12: api.Lider.EscribirJugada:output_type -> api.Signal
	12, // 13: api.Lider.RetornarJugadas:output_type -> api.JugadasArchivo
...
func file_Lider_api_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_Lider_api_api_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
